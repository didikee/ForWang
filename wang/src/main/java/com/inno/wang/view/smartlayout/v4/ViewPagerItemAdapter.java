 ...
 */
package com.inno.wang.view.smartlayout.v4;
...
public abstract class ViewPagerItemAdapter extends PagerAdapter {
  ...
  public Object instantiateItem(ViewGroup container, int position) {
    ...
    setBitmap(view,position);
    container.addView(view);
    holder.put(position, new WeakReference<View>(view));
    return view;
  }

  public abstract void setBitmap(View view,int position);
